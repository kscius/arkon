...
- Name: conagua-checklist.spec.ts >> CONAGUA checklist (browser registry) >> COPY-01 dashboard KPIs use Spanish accents
- Location: e2e\conagua-checklist.spec.ts:9:3
