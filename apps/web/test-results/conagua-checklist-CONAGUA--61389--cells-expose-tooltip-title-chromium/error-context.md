...
- Name: conagua-checklist.spec.ts >> CONAGUA checklist (browser registry) >> OBR-03 truncated cells expose tooltip title
- Location: e2e\conagua-checklist.spec.ts:53:3
