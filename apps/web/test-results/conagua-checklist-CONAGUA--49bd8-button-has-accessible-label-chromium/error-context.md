...
- Name: conagua-checklist.spec.ts >> CONAGUA checklist (browser registry) >> CIE-02 XXII download button has accessible label
- Location: e2e\conagua-checklist.spec.ts:46:3
