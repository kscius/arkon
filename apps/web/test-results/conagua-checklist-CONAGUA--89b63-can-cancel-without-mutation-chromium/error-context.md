...
- Name: conagua-checklist.spec.ts >> CONAGUA checklist (browser registry) >> ALT-02 atender dialog opens and can cancel without mutation
- Location: e2e\conagua-checklist.spec.ts:81:3
